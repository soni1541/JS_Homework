...
function f6() {
    let count = document.querySelectorAll('.p-6').length;
...
function f7() {
    for(let i = 0; blocks7.length; ++i)
    {
        blocks7[i].classList.className = 'bg-orange';
    }
...
function f9() {
    this.classList.className = 'bg-orange'; // все решается одной строкой
}
...
function f11() {
    ...
    new_el.innerText = '25';
    document.querySelector('.out-11').append(new_el);
}
...
function f12() {
    let new_el = document.createElement('div');
    new_el.innerText = '12';
    new_el.classList.add('bg-12');
    document.querySelector('.out-12').append(new_el);
}
...
function f13() {
    let new_el = document.createElement('div');
    new_el.innerText = 'pushMe';
    new_el.classList.add('bg-orange');
    new_el.onclick = f13_1;
    document.querySelector('.out-13').append(new_el);
}
...
function f14() {
    ...
    new_el.innerText = '14';
    new_el.classList.add('bg-orange');
    document.querySelector('.out-14').append(new_el);
}
...
function f15() {
    ...
    new_el.innerText = '15';
    new_el.classList.add('bg-orange');
    document.querySelector('.out-15').before(new_el);
}
...
function f16() {
    ...
    new_el.innerText = '16';
    new_el.classList.add('bg-orange');
    document.querySelector('.out-16').after(new_el);
}
...
function f17() {
    ...
    new_el.innerText = '17';
    new_el.classList.add('bg-orange');
    document.querySelector('.out-17').replaceWith(new_el);
}
...
let ps = document.querySelectorAll('.p-19');
function f19() {
    for (let i = 0; i < ps.length; i++) {
        let data = ps[i].getAttribute('data-b');
...
function f20() {
    let data = document.querySelector('.out-20').setAttribute('title', 'go');
}
