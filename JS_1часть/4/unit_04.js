...
function f5() {
    ...
    if(check.checked)
        result.textContent = check.value;
    else
        result.textContent = false;
}
...
function f6() {
    let value = document.querySelector('.i-6');
...
function f7() {
    ...
    let result_pass = document.querySelector('.out-71');
    result_pass.textContent = password;

    let result_condition = document.querySelector('.out-72');
    if(password.length >= 6)
        result_condition.textContent = 1;
    else
        result_condition.textContent = 0;
}
...
function f11() {
    let color1 =  document.querySelector('.i-111').value;
    document.querySelector('.i-112').value = color1;
}
...
function f13() {
    ...
    document.querySelector('.out-13').textContent = value;
}
...
function f17() {
    ...
    document.querySelector('.out-17').textContent = value;
}
...
function f18() {
    ...
    document.querySelector('.i-18').value = value;
}
...
function f20() {
    let value1 = document.querySelector('.s-201').value;
    document.querySelector('.s-202').value = value1;
}
