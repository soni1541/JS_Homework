...
function f2(){
   ...
   if(a21 > a22)
      result.textContent = a21;
   else
      result.textContent = a22;
...
function f3(){
   ...
   let v1 = Number(document.querySelector('.i-31').value);
   let v2 = Number(document.querySelector('.i-32').value);

   let result = document.querySelector('.out-3');
   if(v1 > v2)
      result.textContent = v1;
   else
      result.textContent = v2;
}
...
function f4(){
   let age = Number(document.querySelector('.i-4').value);
...
function f7(){
   let v1 = Number(document.querySelector('.i-71').value);
   let v2 = Number(document.querySelector('.i-72').value);

   let result = document.querySelector('.out-7');
...
function f8(){
   ...
   switch(value)
   {
      case 1 : result.textContent = 'one'; break;
      case 2 : result.textContent = 'two'; break;
      case 3 : result.textContent = 'three'; break;
   } 
}
...
function f10(){
   ...
   let opt = document.querySelector('.s-100').value;
...
function f14(){
   let v1 = +document.querySelector('.i-141').value;
