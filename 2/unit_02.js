...
function t9() {
    ...
    let data = document.querySelector('input.i-9').value;
...
function t10() {
    ...
    let data = document.querySelector('input.i-10').value;
    document.querySelector('div.out-10').textContent = data * 20;
}
...
function t11() {
    let data = document.querySelector('input.i-11').value;
...
function t12() {
    let name = document.querySelector('input.i-12-1').value;
    let surname = document.querySelector('input.i-12-2').value;
...
function t14() {
    let new_string = 'Go';
    document.querySelector('input.i-14').value = new_string;
}
...
function t16() {
    let v1 = document.querySelector('.i-16-1').value;
    let v2 = document.querySelector('.i-16-2').value;
    let sum = +(v1) + +(v2);
...
function t19() {
    let v1 = +document.querySelector('.i-19-1').value;
    let v2 = +document.querySelector('.i-19-2').value;
    document.querySelector('.out-19').textContent = v1 + v2;
}
